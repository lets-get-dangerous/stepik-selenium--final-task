...
class ProductPage(BasePage):
    ...
    def check_basket_cost_in_message_is_equal(self, price):
        ...
        assert cost == price,\
            "Basket cost is not equal product price."
    ...
    def check_product_name_in_success_message_is_equal(self, product_name):
        ...
        assert name_in_msg == product_name,\
            "Name in the message does not match the product name"
    ...
    def should_be_add_to_cart_button(self):
        assert self.is_element_present(*locator.BUTTON_ADD_TO_CART),\
            "Button 'Add to basket' is not found"
        
    def should_be_basket_cost_message(self):
        assert self.is_element_present(*locator.MESSAGE_CART_COST),\
            "Message with total basket cost is not found"

    def should_be_product_name(self):
        assert self.is_element_present(*locator.PRODUCT_NAME),\
            "Product name is not found"
        
    def should_be_product_price(self):
        assert self.is_element_present(*locator.PRODUCT_PRICE),\
    ...
    def should_dissapear_of_success_message(self):
        assert self.is_disappeared(*locator.MESSAGE_SUCCESS),\
            "Success message should dissapear, but still is presented"
